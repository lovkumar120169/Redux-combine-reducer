...
import { deleteTodoFaliur, deleteTodoRequest, getTodoFaliur, getTodoRequest, getTodoSuccess, updateTodoFaliur, updateTodoRequest } from '../Redux/TodoReducer/action'
...
export const Notes = () => {
    const data = useSelector((store) => store.TodoReducer.TodoArr)
    console.log(data)
